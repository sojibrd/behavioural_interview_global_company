...
export const SITE: {
  ...
  title: "গ্লোবাল কোম্পানির behavioural",
  short: "গ্লোবাল behavioural",
  emoji: "🎙️",
  description:
    "big tech মানের কোম্পানির behavioral round-এর জন্য — ছয়টা STAR story, ফল সংখ্যায়, follow-up-এর গভীরে, ১৮০ দিনের plan-এর story-র ঘরে, learning to learn-এর নীতিতে।",
